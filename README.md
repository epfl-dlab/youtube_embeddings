...
- `path_hdfs` : the path of the directory in `hdfs`. This is possible only if the user has access to the Hadoop cluster. The main `hdfs`commands are shown and explained below.
